...
function(t, e) { !
	function() {
		var t = {}; (location.search || "").substr(1).split("&").forEach(function(e) {
			var r = e.split("=");
			t[r[0]] = r[1]
		});
		var e = t.echarts,
		r = t.external && decodeURIComponent(t.external).split(",");
		if (document.write('<script src="/static/app/map7/dep/echarts/' + e + '/echarts.min.js"></script>'), (r || []).forEach(function(t) {
			...
			window.__currentLayout__ = t.layout,
			"1xN" === t.layout && $("#chart-panel").css("white-space", "nowrap"),
			window.__layoutCustomized__ = "true" === t.layoutCustomized;
			try {
